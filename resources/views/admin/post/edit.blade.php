    ...
    <div class="col-sm-12 p-0">
        <div class="main-header" style="margin-top: 0px;">
            ...
            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                ...
                <li class="breadcrumb-item"><a href="{{route($role . 'post.index')}}">Posts View</a>
                </li>
                <li class="breadcrumb-item"><a href="{{ route($role . 'post.edit', $data->id) }}">Edit Posts</a>
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="card-header">
            ...
            <div class="card-body">
                <div class="p-4 border rounded">
                    <form class="row g-3 needs-validation" novalidate="" action="{{ route($role . 'post.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
